...
for quiz_num in range(35):
    ...
    answer_key_file = open(f'captialsquiz_answers{quiz_num + 1}.txt', 'w')
    ...
    for question_num in range(50):
        ...
        correct_ans = capitals[states[question_num]]
    ...
    answer_key_file.write(f'{question_num + 1}. {"ABCD"[answer_options.index(correct_ans)]}\n')
    quiz_file.close()
